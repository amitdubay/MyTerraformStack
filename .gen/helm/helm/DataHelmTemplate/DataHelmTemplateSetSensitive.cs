...
namespace helm.DataHelmTemplate
{
    ...
    [JsiiByValue(fqn: "helm.dataHelmTemplate.DataHelmTemplateSetSensitive")]
    public class DataHelmTemplateSetSensitive : helm.DataHelmTemplate.IDataHelmTemplateSetSensitive
    {
